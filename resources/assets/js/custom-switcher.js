...
function switcherClick() {
    ...
    /* RTL/LTR functionality removed - application is RTL only */
...
// RTL/LTR functions removed - application is RTL only
...
function ResetAllFn() {
    ...
    // Clean up RTL/LTR from localStorage
...
function checkOptions() {
    ...
    // RTL/LTR checks removed - application is RTL only
