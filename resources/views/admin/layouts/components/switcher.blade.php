<div class="offcanvas offcanvas-start" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">

    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title text-default" id="offcanvasRightLabel">تخصيص المظهر</h5>
    ...
    <div class="offcanvas-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                ...
                <div class="">
                    <p class="switcher-style-head">وضع لون المظهر:</p>
                ...
                <div class="">
                    <p class="switcher-style-head">مواضع الهيدر:</p>
                    <div class="row switcher-style gx-0">
                        <div class="col-4">
                            <div class="form-check switch-select">
            ...
            <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel"
                ...
                <div>
                    <div class="theme-colors">
                        ...
                        <div class="px-4 pb-3 text-muted fs-11">ملاحظة: إذا كنت تريد تغيير لون القائمة ديناميكيًا قم
                            بتغييره من منتقي الألوان الأساسي للمظهر أدناه</div>
                    </div>
                    <div class="theme-colors">
                        ...
                        <div class="px-4 pb-3 text-muted fs-11">ملاحظة: إذا كنت تريد تغيير لون الهيدر ديناميكيًا قم
                            بتغييره من منتقي الألوان الأساسي للمظهر أدناه</div>
                    </div>
                    <div class="theme-colors">
                        <p class="switcher-style-head">اللون الأساسي للمظهر:</p>
                    ...
                    <div class="theme-colors">
                        <p class="switcher-style-head">خلفية المظهر:</p>
                        <div class="d-flex flex-wrap align-items-center switcher-style">
                            <div class="form-check switch-select me-3">
            ...
            <div class="d-grid canvas-footer">
                <a href="javascript:void(0);" id="reset-all" class="btn btn-danger m-1">إعادة تعيين</a>
            </div>
        </div>
    </div>
</div>
