        ...
        <div class="container mx-auto px-6 relative z-10 h-full flex flex-col justify-center">
            ...
            <div class="text-center mb-4 animate-fade-in-down pt-12">
                <div class="flex items-center justify-center gap-2 mb-4">
                    ...
                    <span
                        class="text-[#a41c1c] font-bold tracking-widest uppercase text-sm font-cairo shadow-gray-400">{{ __('frontend.services_page.cards.representation.title') }}</span>
                    <span class="h-px w-12 bg-[#a41c1c]"></span>
                </div>
                ...
                <div class="flex flex-col space-y-8 animate-fade-in-left">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div
                            ...
                            <div>
                                <span
                                    class="block text-xs uppercase tracking-wider text-gray-500 font-bold mb-1">{{ __('legal_representation.duration_title') }}</span>
                                <span
                                    class="text-lg font-bold text-[#1C1C1C]">{{ __('legal_representation.duration') }}</span>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                <span
                                    class="block text-xs uppercase tracking-wider text-gray-500 font-bold mb-1">{{ __('legal_representation.requirements_title') }}</span>
                    ...
                    <div class="pt-4">
                        <a href="{{ route('request') }}?service=legal_representation"
                            ...
                            <span class="z-10">{{ __('legal_representation.request_button') }}</span>
                            <span
