    ...
    <div class="relative min-h-screen bg-soft-white font-sans flex flex-col"
        ...
        <header class="relative z-50 px-6 md:px-8 py-6 flex justify-between items-center shrink-0 animate-fade-in-down">
            <a href="{{ route('business-services.index') }}"
                ...
                <span>{{ __('business_services.common.back_to_services') }}</span>
            </a>
            ...
            <div class="lg:col-span-5 flex flex-col justify-center space-y-8 animate-fade-in-left order-2 lg:order-1">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <span
                            class="text-[#a41c1c] font-bold tracking-widest uppercase text-sm font-cairo">{{ __('business_services.index.title') }}</span>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-6 pt-4">
                    <a href="{{ route('request', ['service' => 'business_services']) }}"
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-3">
                            {{ __('business_services.request_button') }}
                            <span
                    ...
                    <div class="flex items-center gap-2 text-[#606060] font-cairo text-sm">
                        ...
                        <span>{{ __('business_services.services.' . $serviceKey . '.duration') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                        <span class="material-symbols-outlined text-9xl text-[#a41c1c]">
                            {{ __('business_services.services.' . $serviceKey . '.icon') }}
                        </span>
                    </div>
                    ...
                    <ul class="space-y-4 relative z-10">
                        @foreach (__('business_services.services.' . $serviceKey . '.scope') as $item)
                            <li
                                ...
                                <span class="text-[#1C1C1C] font-semibold font-cairo text-lg">{{ $item }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
