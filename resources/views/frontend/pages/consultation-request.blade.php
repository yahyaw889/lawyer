                ...
                <div class="flex flex-col sm:flex-row items-center gap-6 pt-4">
                    <a href="{{ route('consultation.checkout') }}"
                        ...
                        <span class="relative z-10 flex items-center justify-center gap-3">
                            {{ __('consultation_request.request_button') }}
                            <span
                    ...
                    <div class="flex items-center gap-2 text-[#606060] font-cairo text-sm">
                        ...
                        <span>{{ __('consultation_request.duration') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                        <span class="material-symbols-outlined text-9xl text-[#a41c1c]">history_edu</span>
                    </div>
                ...
                <!-- Requirements Card (Handled conditionally if "None" but kept for layout consistency if desired, or modified) -->
                <div class="flex flex-col gap-6 justify-center h-full">
                    <div
                        ...
                        <h3 class="text-xl font-bold font-cairo mb-6 relative z-10 flex items-center gap-3">
                            ...
                            {{ __('consultation_request.requirements_title') }}
                        </h3>

                        <ul class="space-y-5 relative z-10">
                            @foreach (__('consultation_request.requirements') as $req)
