...
@section('content')
    <div class="fixed inset-0 z-50 flex flex-col lg:flex-row bg-white font-cairo"
        ...
        <div class="w-full lg:w-1/2 h-full flex flex-col bg-white relative z-10">
            ...
            <div class="px-6 py-4 flex items-center justify-between border-b border-gray-50">
                <a href="{{ route('home') }}"
                    class="flex items-center gap-2 text-gray-500 hover:text-[#a41c1c] transition-colors">
            ...
            <div class="flex-1 overflow-y-auto custom-scrollbar px-6 py-4 lg:px-12 lg:py-8">
                <div class="max-w-lg mx-auto w-full">
                    ...
                    <form id="consultationForm" class="space-y-5">
                        ...
                        <div class="group">
                            <label
                                class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{{ __('consultation_checkout.fields.name') }}</label>
                            <div class="relative">
                                <span
                                    class="absolute top-1/2 -translate-y-1/2 left-3 rtl:right-3 text-gray-400 material-symbols-outlined text-lg">person</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="group">
                                <label
                                    class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{{ __('consultation_checkout.fields.email') }}</label>
                                <div class="relative">
                                    <span
                                        class="absolute top-1/2 -translate-y-1/2 left-3 rtl:right-3 text-gray-400 material-symbols-outlined text-lg">mail</span>
                            ...
                            <div class="group">
                                <label
                                    class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{{ __('consultation_checkout.fields.phone') }}</label>
                                <div class="relative">
                                    <span
                                        class="absolute top-1/2 -translate-y-1/2 left-3 rtl:right-3 text-gray-400 material-symbols-outlined text-lg">call</span>
                        ...
                        <div class="space-y-3">
                            <label
                                class="block text-xs font-bold text-gray-400 uppercase tracking-wider">{{ __('consultation_checkout.fields.type') }}</label>
                            <div class="grid grid-cols-3 gap-3">
                                <!-- Call -->
                                <label class="cursor-pointer relative">
                                    <input type="radio" name="type" value="call" class="peer sr-only" required>
                                    <div
                                        class="p-4 rounded-xl border-2 border-gray-100 bg-white hover:border-gray-200 peer-checked:border-[#a41c1c] peer-checked:bg-[#a41c1c]/5 transition-all text-center h-full flex flex-col items-center justify-center gap-2">
                                        <span
                                            class="material-symbols-outlined text-2xl text-gray-400 peer-checked:text-[#a41c1c] transition-colors">call</span>
                                        <span
                                            class="text-xs font-bold text-gray-600 peer-checked:text-[#a41c1c]">{{ __('consultation_checkout.types.call') }}</span>
                                    </div>
                                    <div
                                        class="absolute top-2 right-2 rtl:left-2 opacity-0 peer-checked:opacity-100 transition-opacity text-[#a41c1c]">
                                ...
                                <label class="cursor-pointer relative">
                                    ...
                                    <div
                                        class="p-4 rounded-xl border-2 border-gray-100 bg-white hover:border-gray-200 peer-checked:border-[#a41c1c] peer-checked:bg-[#a41c1c]/5 transition-all text-center h-full flex flex-col items-center justify-center gap-2">
                                        <span
                                            class="material-symbols-outlined text-2xl text-gray-400 peer-checked:text-[#a41c1c] transition-colors">videocam</span>
                                        <span
                                            class="text-xs font-bold text-gray-600 peer-checked:text-[#a41c1c]">{{ __('consultation_checkout.types.video') }}</span>
                                    </div>
                                    <div
                                        class="absolute top-2 right-2 rtl:left-2 opacity-0 peer-checked:opacity-100 transition-opacity text-[#a41c1c]">
                                        <span class="material-symbols-outlined text-sm">check_circle</span>
                                ...
                                <label class="cursor-pointer relative">
                                    ...
                                    <div
                                        class="p-4 rounded-xl border-2 border-gray-100 bg-white hover:border-gray-200 peer-checked:border-[#a41c1c] peer-checked:bg-[#a41c1c]/5 transition-all text-center h-full flex flex-col items-center justify-center gap-2">
                                        <span
                                            class="material-symbols-outlined text-2xl text-gray-400 peer-checked:text-[#a41c1c] transition-colors">meeting_room</span>
                                        <span
                                            class="text-xs font-bold text-gray-600 peer-checked:text-[#a41c1c]">{{ __('consultation_checkout.types.office') }}</span>
                                    </div>
                                    <div
                                        class="absolute top-2 right-2 rtl:left-2 opacity-0 peer-checked:opacity-100 transition-opacity text-[#a41c1c]">
                                        <span class="material-symbols-outlined text-sm">check_circle</span>
                        ...
                        <div class="group">
                            <label
                                class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">{{ __('consultation_checkout.fields.topic') }}</label>
                ...
                <div class="max-w-lg mx-auto w-full">
                    <button type="button" id="payBtn"
                        ...
                        <div class="relative z-10 flex items-center justify-center gap-3">
                            <span id="btnText">{{ __('consultation_checkout.pay_button') }} • {{ $price }}
                                SAR</span>
                            <span id="btnSpinner"
                                class="hidden animate-spin h-5 w-5 border-2 border-white border-t-transparent rounded-full"></span>
                        </div>
                        <div
        ...
        <div
            class="hidden lg:flex w-1/2 h-full bg-[#1C1C1C] relative overflow-hidden items-center justify-center p-12 text-white">

            <!-- Abstract Background -->
            <div class="absolute inset-0 z-0">
                <div
                    class="absolute top-0 right-0 w-[600px] h-[600px] bg-[#a41c1c]/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2">
                </div>
                <div
                    class="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-900/20 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2">
                </div>
            </div>
            ...
            <div class="relative z-10 max-w-md w-full">
                <div class="mb-12">
                    <h2 class="text-4xl font-bold mb-4 leading-tight">
                        {{ __('frontend.consultation_checkout.prompt_title') }}<br><span
                            class="text-[#a41c1c]">{{ __('frontend.consultation_checkout.prompt_subtitle') }}</span></h2>
                    <p class="text-gray-400 text-lg leading-relaxed">
                        {{ __('frontend.consultation_checkout.prompt_desc') }}</p>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-6 pb-6 border-b border-white/10">
                        ...
                        <div
                            class="w-12 h-12 bg-[#a41c1c] rounded-full flex items-center justify-center shadow-lg shadow-[#a41c1c]/30">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-baseline gap-1">
                            ...
                            <span
                                class="text-sm font-medium text-gray-400">{{ __('consultation_checkout.currency') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Trust Badges -->
                <div
                    class="mt-8 flex items-center gap-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
