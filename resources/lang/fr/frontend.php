...
return [
    ...
    'hero' => [
        ...
        'firm_name' => 'Cabinet d\'Avocats Al Tamimi',
        'subtitle' => 'Votre Partenaire Juridique de Confiance',
    ],
    'consultation' => [
        'title' => 'Demande de Consultation',
        'subtitle' => 'Connectez-vous directement avec des consultants d\'élite',
        'steps' => [
    ...
    'services' => [
        ...
        'features' => [
            'contracts' => 'Rédaction de Contrats',
            'foreign_inv' => 'Investissement Étranger',
            'compliance' => 'Conformité Légale',
        ],
        'cta' => 'Commencer le Processus Maintenant',
    ],
    'request' => [
